...
abstract class CharacterData {
  ...
  static final List<Perk> perks = [
    ...
    // PAIN CONDUIT
    Perk('painconduit', 1, 'Remove two -1 cards'),
    ...
    Perk('painconduit', 3, 'Replace three +1 cards with three +1 CURSE cards'),
    ...
    Perk('painconduit', 1,
        'Each round in which you long rest, you may ignore all negative condition you have. If you do, they cannot be removed that round'),
    Perk('painconduit', 1,
        'Whenever you become exhausted, first perform CURSE, TARGET all, RANGE 3'),
    Perk('painconduit', 1, 'Increase your maximum hit point value by 5',
        perkIsGrouped: true),
  ];
