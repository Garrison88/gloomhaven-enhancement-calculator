    ...
    ClassCodes.tinkerer: [
      ...
      Perks(
        [
          ...
          Perk(
            '$_add $_one +2 "$_strengthen, Target 1 ally" $_card',
            quantity: 3,
          ),
          Perk(
    ...
    ClassCodes.spellweaver: [
      ...
      Perks(
        [
          ...
          Perk(
            '$_ignoreScenarioEffectsAndRemove $_one +0 $_card',
          ),
          Perk(
    ...
    ClassCodes.shattersong: [
      Perks(
        [
          ...
          Perk(
            'Add one "$_heal 2, $_bless, Target 1 ally" $_rolling card',
            quantity: 2,
          ),
          Perk(
