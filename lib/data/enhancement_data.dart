...
class EnhancementData {
  static final List<Enhancement> enhancements = [
    // plus one
    Enhancement(EnhancementCategory.title, null, 'plus_one.png', false,
        ' For Character'),
    ...
    Enhancement(
        EnhancementCategory.charPlusOne, 30, 'range.png', true, 'Range'),
    Enhancement(
    ...
    Enhancement(EnhancementCategory.charPlusOne, 100, 'retaliate.png', true,
        'Retaliate'),
    ...
    Enhancement(
        EnhancementCategory.summonPlusOne, 100, 'move.png', true, 'Move'),
    Enhancement(
    ...
    Enhancement(
        EnhancementCategory.negEffect, 75, 'poison.png', false, 'Poison'),
    Enhancement(EnhancementCategory.negEffect, 75, 'wound.png', false, 'Wound'),
    Enhancement(
        EnhancementCategory.negEffect, 50, 'muddle.png', false, 'Muddle'),
    ...
    // positive effects
    Enhancement(EnhancementCategory.posEffect, 50, 'strengthen.png', false,
        'Strengthen'),
    Enhancement(EnhancementCategory.posEffect, 50, 'bless.png', false, 'Bless'),
    Enhancement(EnhancementCategory.posEffect, 50, 'regenerate.png', false,
        'Regenerate'),
    ...
    Enhancement(
        EnhancementCategory.hex, 66, 'hex.png', false, '3 Current Hexes'),
    Enhancement(
        EnhancementCategory.hex, 50, 'hex.png', false, '4 Current Hexes'),
    Enhancement(
        EnhancementCategory.hex, 40, 'hex.png', false, '5 Current Hexes'),
    Enhancement(
        EnhancementCategory.hex, 33, 'hex.png', false, '6 Current Hexes'),
    Enhancement(
        EnhancementCategory.hex, 28, 'hex.png', false, '7 Current Hexes'),
    Enhancement(
        EnhancementCategory.hex, 25, 'hex.png', false, '8 Current Hexes'),
    Enhancement(
        EnhancementCategory.hex, 22, 'hex.png', false, '9 Current Hexes'),
    Enhancement(
  ...
  static List<DropdownMenuItem<Enhancement>> enhancementTypes() {
    ...
    enhancements.forEach((enhancement) => list.add(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      enhancement.category == EnhancementCategory.charPlusOne ||
                          ...
                          ? Stack(
                              alignment: Alignment(1.75, -1.75),
                              children: <Widget>[
                                enhancement.invertColor &&
