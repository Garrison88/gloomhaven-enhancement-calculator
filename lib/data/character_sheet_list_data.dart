...
List<PlayerClass> classList = [
  ...
  PlayerClass('Aesther', 'Diviner', 'DI', 'diviner.png', false, "0xff8bc5d3",
      _diPerkList)
];
...
List<PerkRow.Perk> perkList = [
  ...
  PerkRow.Perk('BR', 1, 'Add one +3 cards'),
  ...
  PerkRow.Perk('TI', 1, 'Add one +3 cards'),
  ...
  PerkRow.Perk(
      'PH', 1, 'Ignore negative SCENARIO effects and add one +1 cards'),
  // BERSERKER
  ...
  PerkRow.Perk('BE', 1, 'Add one Rolling +1 DISARM cards'),
