...
List<Perk> _brPerkList = [
  ...
  Perk('BR', 1, 'Add one DISARM card and one MUDDLE card'),
...
List<Perk> _swPerkList = [
  ...
  Perk('SW', 1, 'Add one rolling EARTH and one rolling WIND card'),
...
List<Perk> _chPerkList = [
  ...
  Perk('CH', 1, 'Add two rolling WIND cards'),
...
List<Perk> _skPerkList = [
  ...
  Perk('SK', 2, 'Add two rolling SUN cards'),
...
List<Perk> _suPerkList = [
  ...
  Perk('SU', 1, 'Add one rolling FIRE and one rolling WIND card'),
  ...
  for (int x = 0; x < _classList.length; x++) {
    _list.add(DropdownMenuItem(
        child: Row(
          children: <Widget>[
            Image.asset(
              'images/class_icons/${_classList[x].icon}',
              width: iconWidth,
              color: _classList[x].color,
            ),
